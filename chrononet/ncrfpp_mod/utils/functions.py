...
def read_instance(X, Y, word_alphabet, char_alphabet, feature_alphabets, label_alphabet, number_normalized, max_sent_length, char_padding_size=-1, char_padding_symbol = '</pad>'):
    ...
    for k in range(len(X)):
        ...
        if (len(words) > 0) and ((max_sent_length < 0) or (len(words) < max_sent_length)):
            ...
            print('WARNING: instance not added!')
        words = []
        features = []
        chars = []
        labels = []
